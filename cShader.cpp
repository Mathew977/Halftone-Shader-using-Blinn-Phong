...
char *vShader[] = {	"shaders\\Blinn-Phong.vert",	// FLAG_MAPS_INTENSITYS
					"shaders\\Halftone Shader.vert", // LOAD IN HALFTONE VERT FILE
					"shaders\\Lighting Detector.vert", // LOAD IN LIGHTING DETECTOR VERT FILE
};

char *fShader[] = {	"shaders\\Blinn-Phong.frag",	// FLAG_MAPS_INTENSITY
					"shaders\\Halftone Shader.frag", // LOAD IN HALFTONE FRAG FILE
					"shaders\\Lighting Detector.frag", // LOAD IN LIGHTING DETECTOR FRAG FILE
};
