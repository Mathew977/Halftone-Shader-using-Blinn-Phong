...
public:
	...
	inline GLint	halftoneValue()
	{
		return m_halftoneValue;
	}
	inline GLint	screenXSize()
	{
		return m_screenXSize;
	}
	inline GLint	screenYSize()
	{
		return m_screenYSize;
	}
